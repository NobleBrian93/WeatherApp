...
class Weather{
    constructor(city){
        this.city = city;
        this.apiKey = '38bb43c735ba5b97ac156f0bebf15295';
        this.loader = document.querySelector('#img__loader');
    }
...
class Cities {
    constructor() {
        this.api = 'https://restcountries.eu/rest/v2/region/africa'
    }
...
document.querySelector('.app__left').addEventListener('submit', (e) => {
    ...
    if(myCity !== ''){
        ...
        ui.showAlert('.empty__field', 'Please enter city name to continue');
    }
});
